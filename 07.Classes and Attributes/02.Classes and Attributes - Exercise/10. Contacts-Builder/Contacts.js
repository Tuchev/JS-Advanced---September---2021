...
let contacts = [
    new Contacts("Ivan", "Ivanov", "0888 123 456", "i.ivanov@gmail.com"),
    new Contacts("Maria", "Petrova", "0899 987 654", "mar4eto@abv.bg"),
    new Contacts("Jordan", "Kirov", "0988 456 789", "jordk@gmail.com")
];
