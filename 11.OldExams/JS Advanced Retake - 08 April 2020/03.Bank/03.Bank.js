class Bank {
    ...
    depositMoney(id, a) {
        ...
        customer.transactions.push(`${customer.firstName} ${customer.lastName} made deposit of ${a}$!`);
    ...
    withdrawMoney(id, a) {
        ...
        customer.transactions.push(`${customer.firstName} ${customer.lastName} withdrew ${a}$!`);
        return `${customer.totalMoney}$`;
    }
